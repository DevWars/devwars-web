    ...
    <div>
        ...
        <div class="home-section">
            <div class="container">
                ...
                <p class="home-section__desc">We are peaking the interests of well-known developers and
                    organizations</p>
                    ...
                    <div class="col-md-4">
                        <div class="quote-card card">
                            <div class="card__inner">
                                ...
                                <a
                                    href="https://twitter.com/scotch_io/" class="quote-card__username" target="_blank"
                                    rel="nofollow"
                                >@scotch_io</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="quote-card card">
                            <div class="card__inner">
                                ...
                                <a
                                    href="https://twitter.com/DevTipsShow/" class="quote-card__username" target="_blank"
                                    rel="nofollow"
                                >@devtips</a>
                            </div>
                        </div>
