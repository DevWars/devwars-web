        ...
        <Row>
            <Column :md="8">
                ...
                <div class="group">
                    ...
                    />
                    <span
                        >Learn about new DevWars features or
                        announcements.</span
                    >
                </div>
                ...
                <div class="group">
                    <Checkbox
                        ...
                        :checked="schedules"
                        @input="
                            updateForm({ values: $event, key: 'schedules' })
                        "
                    />
...
export default {
    ...
    computed: {
        ...mapState({
            ...
            gameApplications: (state) =>
                state.user.emailPermissions.gameApplications,
            schedules: (state) => state.user.emailPermissions.schedules,
            linkedAccounts: (state) =>
                state.user.emailPermissions.linkedAccounts,
        }),
