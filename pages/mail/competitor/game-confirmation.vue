    ...
    <MailMeta subject="Confirm Your DevWars Entry">
        <mj-section>
            <mj-column>
                ...
                >You are entered to compete in DevWars.</mj-text>
                <mj-text
                    align="center"
                    line-height="1.3"
                    font-size="16px"
        ...
        <mj-section padding="0">
            <mj-column>
                <mj-text
                    ...
                    color="#fff"
                    font-family="helvetica"
                >{{ game.startTime | moment('fullDateWithTime') }}</mj-text>
                <mj-text
                    align="center"
                    font-size="16px"
                    color="#fff"
                    font-family="helvetica"
                >DevWars Competition</mj-text>
                <mj-button
                    ...
                    font-size="14px"
                    font-weight="bold"
                >Convert to my timezone</mj-button>
            </mj-column>
        </mj-section>
        ...
        <mj-section>
            <mj-column>
                <mj-text
                    ...
                    color="#fff"
                    font-family="helvetica"
                >Don't think you can make it?</mj-text>
                <mj-button
