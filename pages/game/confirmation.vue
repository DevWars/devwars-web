            ...
            <Container>
                <Card>
                    ...
                    <p>
                        ...
                        selected to play. Only 6 players will be selected, one
                        for each position.
                    </p>

                    <h2>How to prepare</h2>
                    <p>
                        There are a lot of things you should probably catch up
                        on before game day. Below is our DevWars Documentation
