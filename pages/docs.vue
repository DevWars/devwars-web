            ...
            <div class="nav">
                ...
                <div class="warning">
                    ...
                    <p>
                        ...
                        More sections will be added over time, please check back frequently for updates.
                    </p>
            ...
            <article id="devwars">
                ...
                <section id="about">
                    ...
                    <p>
                        ...
                        controlling a single language - HTML, CSS and JavaScript.
                    </p>
                </section>
                <section id="positions">
                    <h2>Positions</h2>
                    <p>
                        Each player can only code in the language they are assigned
                ...
                <section id="game-modes">
                    <h2>Game Modes</h2>
                    <p>
                        In DevWars, each game mode offers unique playing experience
                        with its own set of rules and conditions.
                    </p>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            with a theme and a set of objectives.
                        </p>
                    </section>
                ...
                <section id="objectives">
                    <h2>Objectives</h2>
                    <p>
                        Primary focus in 3v3 matches is to fulfil certain objectives in order to
                    ...
                    <section id="strikes">
                        <h3>Strikes</h3>
                        <p>
                            If the game show host finds a submitted objective to be incomplete,
                            the team will earn a strike. Once a team reaches 3 strikes, the bonus
                            objective will be eliminated from that team.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            After the clock runs out, the game show host will do a final review of
                            all the objectives completed for both teams. Points earned from a completed
                            objective will be lost if found to be incomplete during the final review.
                        </p>
                    </section>
                </section>
                ...
                <section id="points">
                    <h3>Points</h3>
                    <p>
                        The team with the most points wins the game. Below is a chart displaying a
                        list of points you can earn in each Phase:
                    </p>
                    <table>
                        <thead>
                            <tr>
                ...
                <section id="rules">
                    ...
                    <ol>
                        ...
                        <li>
                            No copying and pasting of code, however copying code and URLs from teammates
                            is acceptable.
                        </li>
            ...
            <article id="watching">
                ...
                <section id="voting">
                    ...
                    <section>
                        ...
                        <p>
                            Depending on how many votes a team gets in each category up to two (2) points
                            can be earned if certain thresholds are exceeded. Thresholds are determined by
                            the percentage of total votes per team.
                        </p>
                        <table>
                            <thead>
                                <tr>
                    ...
                    <section id="vote-ui">
                        ...
                        <p>
                            Base your vote on the overall design of the website. The interface should
                    ...
                    <section id="vote-ux">
                        ...
                        <p>
                            Base your vote on how you feel when interacting with the website. It should
                    ...
                    <section>
                        <h3>Tie Breaker</h3>
                        <p>
                            If the points on both teams are tied, we run a Tie Breaker for the best overall
                ...
                <section id="betting">
                    <h2>Betting</h2>
                    <p>
                        Put your hard earned Devcoins on the line by betting on which team you think
                    ...
                    <section>
                        <h3>Payouts</h3>
                        <p>
                            Win more Devcoins depending on how specific your bet is. The lower the odds,
                            the greater the payout. Below is a chart of payouts against different odds:
                        </p>
