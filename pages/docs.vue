        ...
        <Column :sm="3" class="sidebar">
            <div class="nav">
                ...
                <div class="warning">
                    ...
                    <p>
                        This documentation is currently under development. More
        ...
        <Column :sm="9" class="main">
            <article id="devwars">
                ...
                <section id="about">
                    <h2>About</h2>
                    <p>
                        People of all levels are invited to participate in an
                        exhilarating battle to create the best website they can
                        within 60 minutes. Teams are formed of 3 people, with
                        the team's members each controlling a single language -
                ...
                <section id="positions">
                    <h2>Positions</h2>
                    <p>
                        Each player can only code in the language they are
                        assigned to. This requires teams to communicate in order
                        to complete their website in unison. There are currently
                        only 3 positions available to play in DevWars: HTML, CSS
                        and JavaScript.
                    </p>
                    ...
                    <p>
                        Each position plays a critical role for the team. HTML
                        is in charge of templating the DOM, CSS handles the
                        design for the website and JavaScript brings
                ...
                <section id="game-modes">
                    <h2>Game Modes</h2>
                    <p>
                        In DevWars, each game mode offers unique playing
                        experience with its own set of rules and conditions.
                    </p>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            features all 3 supported languages. Two teams of
                            three, face off against each other with a theme and
                            a set of objectives.
                        </p>
                    </section>
                ...
                <section id="themes">
                    <h2>Themes</h2>
                    <p>
                        Every game mode is paired with a theme to keep the
                        websites comparable between both teams.
                    </p>
                </section>
                ...
                <section id="objectives">
                    <h2>Objectives</h2>
                    <p>
                        Primary focus in 3v3 matches is to fulfil certain
                        objectives in order to gain the points needed to
                        overtake the opposing team. These do not have to be
                        completed in order and as soon as a team declares an
                        objective fulfilled, the host checks if the requirements
                        have been met. Only if that is the case the team gets a
                        point.
                    </p>
                    ...
                    <section>
                        ...
                        <p>
                            When an objective is complete, players must request
                            the objective to be removed by the game show host in
                            order to secure the point(s).
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            Unlike standard objectives, bonus objectives are
                            worth 2 points instead of 1 and are denoted by a
                            <span class="color-bonus">gold color</span>. By
                            default, bonus objectives are locked and cannot be
                            achieved until all 4 standard objectives have been
                            completed.
                        </p>
                    </section>
                    ...
                    <section id="strikes">
                        <h3>Strikes</h3>
                        <p>
                            If the game show host finds a submitted objective to
                            be incomplete, the team will earn a strike. Once a
                            team reaches 3 strikes, the bonus objective will be
                            eliminated from that team.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            After the clock runs out, the game show host will do
                            a final review of all the objectives completed for
                            both teams. Points earned from a completed objective
                            will be lost if found to be incomplete during the
                            final review.
                        </p>
                    </section>
                </section>
                ...
                <section id="points">
                    <h3>Points</h3>
                    <p>
                        The team with the most points wins the game. Below is a
                        chart displaying a list of points you can earn in each
                        Phase:
                    </p>
                    <table>
                        <thead>
                ...
                <section id="rules">
                    ...
                    <ol>
                        ...
                        <li>
                            No copying and pasting of code, however copying code
                        ...
                        <li>
                            Inline styling is not allowed. All styling must be
                            performed using CSS.
                        </li>
                        <li>
            ...
            <article id="watching">
                ...
                <section id="tools">
                    <h2>Tools</h2>
                    <p>
                        Below are products and resources that will help improve
                        your viewing experience during a live game.
                    </p>
                    <div class="section tools">
                        <ul>
                            <li>
                                <a
                                    href="https://watch.devwars.tv"
                                    target="_blank"
                                >
                                    ...
                                    <div class="tools__main">
                                        <h3>Live Code</h3>
                                        <p>
                                            Watch players code in real-time and
                                            preview their websites.
                                        </p>
                                    </div>
                                </a>
                            </li>
                            <li>
                                ...
                                >
                                    ...
                                    <div class="tools__main">
                                        <h3>Eavesdrop</h3>
                                        <p>
                                            Listen in on what the teams are
                                            saying during a live game.
                                        </p>
                                    </div>
                                </a>
                            </li>
                ...
                <section id="voting">
                    <h2>Voting</h2>
                    <p>
                        In addition to the objectives, our audience awards
                        additional points in the categories
                        <a href="#vote-ui">UI</a> and <a href="#vote-ux">UX</a>.
                    </p>
                    <p>
                        To participate in voting, type
                        <code>!blue</code> or <code>!red</code> in the chat to
                        express your personal favorite in each category when
                        prompted.
                    </p>
                    ...
                    <section>
                        ...
                        <p>
                            Depending on how many votes a team gets in each
                            category up to two (2) points can be earned if
                            certain thresholds are exceeded. Thresholds are
                            determined by the percentage of total votes per
                            team.
                        </p>
                        <table>
                            <thead>
                    ...
                    <section id="vote-ui">
                        ...
                        <p>
                            Base your vote on the overall design of the website.
                            The interface should feel coherent with consistent
                            use of elements. The website should be responsive,
                            look good on mobile and follow the game's theme.
                        </p>
                    </section>
                    ...
                    <section id="vote-ux">
                        ...
                        <p>
                            Base your vote on how you feel when interacting with
                            the website. It should be simple to use and easy to
                            navigate. Look for things such as bugs or poor
                            execution of functionality by way of design.
                        </p>
                    </section>
                    ...
                    <section>
                        <h3>Tie Breaker</h3>
                        <p>
                            If the points on both teams are tied, we run a Tie
                            Breaker for the best overall team. Users vote
                            blindly, meaning, the voting bars will not be
                            displayed on the stream. In the unlikely event that
                            there is a tie in the tie breaker, the game host
                            will make the final decision and declare the winner.
                        </p>
                    </section>
                </section>
                ...
                <section id="betting">
                    <h2>Betting</h2>
                    <p>
                        Put your hard earned Devcoins on the line by betting on
                        which team you think will win the game. Betting is only
                        open for ten minutes after the first five minutes of the
                        match.
                    </p>
                    <p>
                        You can bet with the following command in the Twitch
                        chat:
                        <br />
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        A minimum of 50 Devcoins are required to
                                        place a bet.
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <section>
                        <p>
                            ...
                            <br />Enter the <u>minimum</u> number of objectives
                            you think the team will secure.
                        </p>
                        <table>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>ace</td>
                                    <td>
                                        Alias to typing (5) indiciating that the
                                        team will secure all objectives
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <section>
                        <h3>Payouts</h3>
                        <p>
                            Win more Devcoins depending on how specific your bet
                            is. The lower the odds, the greater the payout.
                            Below is a chart of payouts against different odds:
                        </p>
            ...
            <article id="competing">
                <header>
                    <h1>Competing</h1>
                    <p>
                        Compete in live DevWars games for a unique team-building
                        experience.
                    </p>
                </header>
                ...
                <section id="requirements">
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            you can speak with your teammates during a live
                ...
                <section id="editor">
                    ...
                    <section>
                        <h3>Game View</h3>
                        <p>
                            Each player has their own view with a full-height
                            editor, a window to display the rendered website and
                            documents to preview other team members.
                        </p>
                        <p>
                            During the game, players can see the live timer,
                            points, and strikes.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            You can use the following keyboard shortcuts in the
                            DevWars editor (currently only displaying Windows
                            keyboard layout):
                        </p>
                        <table>
                            <thead>
                    ...
                    <section>
                        ...
                        <p>
                            It is important for you to save your document
                            frequently using
                            <span class="keybinding">Ctrl+S</span>. Make sure to
                            only save when your code is complete. The viewers
                            and game host will not be able to render your
                            website until you have saved your changes.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            When you complete an objective, you must submit it
                            for review. To submit an objective, click the
                            checkbox icon on the top left corner of the game
                            view.
                        </p>
                        <p>
                            Tip: Make sure all team members are ready before
                            marking an objective complete or else your team
                            could potentially
            ...
            <article id="earning">
                ...
                <section id="devcoins">
                    <h2>Devcoins</h2>
                    <p>Earn Devcoins to spend on cool elements in the Shop.</p>

                    <section>
                        <h3>How to earn</h3>
                        <p>
                            Below are all the different ways you can earn more
                            precious Devcoins:
                        </p>
                        <table>
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Place
                                        <a href="#betting">Bets</a> during a
                                        game
                                    </td>
                                    <td>
                                        <span class="keybinding">Variable</span>
...
// Not currently using -- delete this comment when you do
.callout {
    padding: 1.25rem;
    margin-top: 1.25rem;
